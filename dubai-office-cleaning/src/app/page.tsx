...
const stats = [
  ...
  { icon: ClipboardList, label: "Weekly or every two weeks" },
  { icon: MapPin, label: "Dubai business districts" },
...
const steps = [
  {
    ...
    body: "Tell us the area, roughly how big the office is, and whether you want weekly or every two weeks. We will call or WhatsApp you back the same business day.",
  },
  {
    n: "02",
    ...
    <>
        ...
        <div className="relative mx-auto grid min-h-[640px] max-w-6xl items-center gap-10 px-4 py-20 sm:px-6 md:min-h-[720px] lg:grid-cols-[1.15fr_0.85fr]">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-neutral-700">
              ...
              checklist, and come back weekly or every two weeks. Business Bay to Marina, JLT and nearby districts.
            </p>
          ...
          <div className="hidden justify-self-end lg:block">
            <div className="rounded-3xl bg-white/85 p-6 shadow-xl backdrop-blur">
              ...
              <p className="mt-2 text-sm leading-relaxed text-neutral-600">
                Weekly or every two weeks after-hours cleans. A written quote after
          ...
          >
            ...
            <div className="flex flex-col justify-center p-8">
              ...
              <ul className="mt-5 space-y-2 text-sm text-neutral-700">
                ...
                <li>Weekly or every two weeks after close</li>
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2">
          ...
          <div>
            ...
            <h2 className="mt-3 font-heading text-3xl font-extrabold text-[#0f6b4c] md:text-4xl">
              Local cleaning for Dubai workplaces
            </h2>
            <p className="mt-5 leading-relaxed text-neutral-700">
              ...
              clean the same way every visit — in Business Bay, DIFC, Marina, JLT and nearby districts.
            </p>
            <p className="mt-4 leading-relaxed text-neutral-700">
              Schools, medical rooms, gyms and large building common areas come later, once
      ...
      <section className="bg-[#f3faf6] py-16 md:py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-center text-neutral-600">
            Small and medium offices across Dubai. If you are near
