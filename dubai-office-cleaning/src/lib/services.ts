...
export const services: Service[] = [
  {
    ...
    excerpt:
      "A well-cleaned office shows the professionalism of your company and makes the workplace easier to use the next morning.",
    intro:
      "This is our core work: after-hours cleaning for small and medium offices in Dubai. We walk the site with you, write a simple checklist, then come back weekly or every two weeks so desks, pantries, washrooms and floors stay consistent.",
    ...
    tasks: [
      ...
      "Pantry benches, sinks, microwaves and fridges",
      "Dishes washed or dishwasher stacked and emptied",
      "Office waste and recycling bins emptied",
      "Washroom cleaning, disinfecting and deodorising",
    ...
    highlights: [
      ...
      },
      {
        ...
        body: "From a Business Bay suite to an Al Quoz warehouse office, we document the scope so every visit is consistent.",
      },
      {
        title: "Insured, uniformed, site-ready",
        body: "Cleaners arrive with commercial equipment, colour-coded cloths and the access rules your building security expects.",
      },
    ],
  },
  {
    slug: "buildings-communities",
    title: "Building & Community Cleaning",
    shortTitle: "Building & Community Cleaning",
    navLabel: "Building & Community Cleaning",
    formValue: "Building & Community Cleaning",
    excerpt:
      "We keep lobbies, lifts and common areas presentable for tenants, visitors and building managers.",
    intro:
      "Tower and community sites live on first impressions. We clean lobbies, lifts, stairwells, amenities and outdoor common areas to a standard residents notice — and that facilities managers can report on. We take this work after office programs are in place, not as the first job.",
    image: "/images/building common areas.jpg",
    ...
    tasks: [
      ...
      "Internal corridors and mailbox areas",
  ...
  },
  {
    ...
    excerpt:
      "Hygiene that protects staff, patients and visitors — with the discipline clinic rooms actually require.",
    intro:
      "Clinics cannot run on a generic office clean. We follow a documented room routine: high-touch disinfection, waiting rooms that look cared for, and amenities that meet the standard your patients expect. Ask first — we only take clinics once the company is licensed and the team is briefed.",
    ...
    tasks: [
      ...
      "Staff rooms, pantries and change areas",
  ...
  },
  {
    ...
    title: "Schools & Nursery Cleaning",
    shortTitle: "Schools – Nurseries – Centres Cleaning",
    navLabel: "Schools & Nurseries",
    formValue: "Schools & Nursery Cleaning",
    excerpt:
      "A safe, clean environment for students, educators and families — every day the centre is open.",
    intro:
      "Nurseries and school sites have to look clean and actually be clean. We plan around pick-up, nap times and after-hours access, with products suited to children underfoot. This is later work, not the first contract we take.",
    ...
    highlights: [
      {
        ...
        body: "We specify low-odour chemicals suitable for education and early-learning sites.",
      },
      {
        title: "Screened team",
        body: "Staff on school and nursery sites work only after the company visa and required checks are in place.",
      },
      {
  ...
  },
  {
    ...
    intro:
      "Gyms get dirty in a very specific way. We plan around class timetables, peak hours and 24-hour access so equipment, change rooms and floors stay member-ready. Ask if you want this — office work is what we book first.",
    ...
    highlights: [
      {
        ...
        body: "We can split visits: a morning reset and an evening deep pass so evening traffic never walks into a tired floor.",
      },
      {
