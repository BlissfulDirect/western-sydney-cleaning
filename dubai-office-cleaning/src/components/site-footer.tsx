    ...
    <footer className="bg-[#0c3d2e] text-white">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="mt-5 text-sm leading-relaxed text-white/80">
            After-hours office cleaning for offices across Dubai.
            Small and medium workplaces first — weekly and every two weeks programs.
          </p>
        </div>
        <div>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-6xl flex-col gap-2 px-4 py-5 text-xs text-white/60 sm:flex-row sm:items-center sm:justify-between sm:px-6">
          ...
          <p>Commercial cleaning contractors · Dubai · {site.licenceNote}</p>
        </div>
      </div>
    </footer>
  );
