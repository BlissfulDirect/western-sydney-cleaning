...
export function FreeCleanBanner() {
  return (
    <section className="bg-[#1259a5] py-16 text-white">
      <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr]">
        <div>
          <p className="text-sm font-bold tracking-[0.2em] uppercase text-[#7fd3f5]">
            Limited Time Offer
          </p>
        ...
        <div className="rounded-3xl bg-[#0e4a8a] p-6 shadow-2xl sm:p-8">
