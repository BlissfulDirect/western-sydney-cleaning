    ...
    <>
      ...
      <section className="bg-white py-16 md:py-20">
        <div className="mx-auto grid max-w-6xl gap-12 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            ...
            <h3 className="mt-10 font-heading text-xl font-bold text-[#1259a5]">
            ...
            <ul className="mt-5 grid gap-2 sm:grid-cols-2">
              {service.tasks.map((task) => (
                <li key={task} className="flex gap-2 text-sm text-neutral-700">
                  <CheckCircle2 className="mt-0.5 size-4 shrink-0 text-[#26a9e0]" />
                  {task}
                </li>
              ))}
            </ul>
      ...
      <section className="bg-[#f4fbfd] py-16">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <p className="font-script text-3xl text-[#26a9e0]">Experienced & enthusiastic</p>
          ...
          <p className="mt-4 max-w-3xl leading-relaxed text-neutral-700">
            ...
            <a href={site.phoneHref} className="font-bold text-[#1259a5]">
              {site.phone}
            </a>{" "}
